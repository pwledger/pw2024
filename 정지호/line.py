...
#위쪽 좌표 < 아래쪽 좌표   왼쪽 좌표 < 오른쪽 좌표
src = cv2.line(src, (100, 100), (1200, 100), (0, 0, 255), 3, cv2.LINE_AA) # 시작점 , 끝나는 점, 색깔 , 굵기
src = cv2.circle(src, (300, 300), 50, (0, 255, 0), cv2.FILLED, cv2.LINE_4) #중심점 , 반지름 , 색깔
src = cv2.rectangle(src, (500, 200), (1000, 400), (255, 0, 0), 5, cv2.LINE_8) # 왼쪽위꼭짓점,오른쪽아래꼭짓점,모서리색,모서리굵기
